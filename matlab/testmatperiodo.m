...
%DOCCIA
sequenza1=[1, 2, 4, 1, 3, 5, 6, 1, 1, 7, 1, 1, 8, 1, 1, 1, 1, 7, 1, 1, 1, 4, 9, 10, 1, 1, 8, 1];
stato1=[1, 2, 2, 1, 2, 2, 2, 1, 1, 2, 1, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 2, 2, 2, 1, 1, 2, 1];

sequenza2=[2, 1, 1, 4, 1, 1, 1, 1, 3, 5, 6, 7, 1, 4, 8, 1, 1, 9, 1, 1, 1, 1, 1, 1, 1, 11, 12, 10];
stato2=[2, 1, 1, 2, 1, 1, 1, 1, 2, 2, 2, 2, 1, 2, 2, 1, 1, 2, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2];

sequenza3=[2, 1, 3, 4, 1, 5, 6, 7, 8, 9, 1, 10, 1, 11, 12, 13, 8, 14, 1, 1, 15, 16, 13, 17, 18, 19, 1, 1];
stato3=[2, 1, 2, 2, 1, 2, 2, 2, 2, 2, 1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 1, 1];

% 0 emissioni == stato 1%
% >0 emissioni == stato 2%
[trans, emis] = hmmestimate(sequenza3, stato3);
